...
Hm, this is pretty hard to see. Let's visualize it.[^4]

[^4]: This would be a lot easier using `ggplot2` by the way. We will cover data visualization with `ggplot2` in the next workshop. Stay tuned!
```{r}
